...
3. DEFAULT LANE = STAGE 2 sequence: [P2.1 SPEC LANDED 2026-09-03, ef6b7f5, docs/specs/10-artifact-format.md] P2.1 review gate [APPROVED 2026-09-03, 89eaf24] -> P2.1 impl (artifact+xref) -> P2.2 project store -> P2.3 string/secrets indexer -> P2.4 reuse validation (Semgrep/OSV vs deps) -> P2.5 version diff -> P2.6/P2.7. Decision-8 spec+review gate for each. Stage 3 (deobf + dead-code-annotate) after Stage 2, unchanged.
