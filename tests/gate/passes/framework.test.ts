...
test("PL-05: --passes=none reproduces the M4 emitter output byte for byte", () => {
  ...
  assert.equal(decompile(bytes, { passes: { skip: ["finally-dedup", "loop-cond", "for-header", "for-in", "for-of", "switch-raise", "if-chain", "try-shape", "label-clean", "expr-rebuild", "global-access", "globalthis-dead-store", "call-shape", "default-params", "destructure", "spread-rest", "template-literal", "optional-chain", "object-literal", "yield-recovery", "yield-loop", "async-recovery", "arguments-form", "literal-forms", "try-clean", "class-recover", "super-call", "ctor-this", "fn-naming", "reg-split", "var-naming"] }, moduleName: "x" }).code, none);
});
