...
| OSV.dev data | `CC-BY 4.0` (not a GitHub-hosted repo; verdict per https://osv.dev/docs/, unchanged from spec draft) | https://osv.dev/docs/ | 2026-09-03 | data — attribute via `who:"osv@<db-date>"` in every finding's provenance + a NOTICE line (added when Lane O lands, step 2) |
